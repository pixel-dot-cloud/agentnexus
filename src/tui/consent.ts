// TUI-specific ConsentManager with promptFn callback.
// The base ConsentManager in src/lib/consent.ts is used by the daemon channel
// adapters (which resolve consent through their own UI). This version is used
// by the Ink TUI where consent is wired through React state + a Promise.
